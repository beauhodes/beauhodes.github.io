...
Well, I will try my best to answer most of these questions! Except the last one. As for that one, hopefully you have a better idea of your own answer after reading this article, as this is obviously an issue that is being worked on and will affect future blockchain usage and miners.
<br/>
<br/>
...
Additionally, there is some concern over the carbon emissions resulting from the proof of work required by the current Ethereum blockchain. I'll talk a bit more about this in the closing notes.
<br/>
<br/>
...
- Carbon emissions from creating and moving NFTs around is a big issue to be worked on, just as it is with other proof of work based crypto projects. ETH 2.0 is actually moving to proof of stake in order to try and tackle this problem, among other reasons. Until then, other upgrades are being implemented to alleviate some on-chain burden, such as rollups (layer 2) and the Berlin Upgrade (which actually launched today, April 14th, 2021). 

...
This tokenURI function, when called with a specified tokenID parameter, checks to make sure the the tokenId exists and, if so, returns the link stored in the tokenURIs array. Pretty simple, right?
